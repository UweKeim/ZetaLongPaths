...
This is a fork for [ZetaLongPaths](https://github.com/UweKeim/ZetaLongPaths) project. It was created for library maintenance: critical bugs fixing and new functionality implementation. 
